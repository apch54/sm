...
.iphone-slider input,input {
  background-image:-webkit-gradient(linear,left top,left bottom,
      color-stop(0,<?php print $colors->sliderfs_gradiant_start ?>),color-stop(1,<?php print $colors->sliderfs_gradiant_end ?>)   ) !important;
  }
.iphone-slider input::-webkit-slider-thumb,input::-webkit-slider-thumb {
  background-image:url('data:image/png;base64,'),-webkit-gradient(linear,left top,left bottom,
    ...
    color-stop(1,<?php print $colors->sliderfs_gradiant_end ?>)   ) !important;
